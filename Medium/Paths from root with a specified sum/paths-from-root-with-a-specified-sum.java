...
class Solution
{
    ...
    public void dfs( Node node, int sum, int cur, ArrayList< Integer > temp, ArrayList< ArrayList< Integer > > ans)
    {
        if( node == null )
        {
            return;
        ...
        dfs( node.left, sum, cur, temp, ans );
        dfs( node. right, sum, cur, temp, ans );
